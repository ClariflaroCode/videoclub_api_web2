...
El prefijo para las consultas una vez descargado el proyecto en la carpeta htdocs de XAMPP y guardado en una carpeta llamada proyectos, debe ser: http://localhost/proyectos/videoclub_api_web2/backend/api/ 
